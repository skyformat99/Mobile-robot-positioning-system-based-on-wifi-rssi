	       ...
	       int		has_range)
{
 ...
 //  printf("in the iw_print_stats  hahahaha!\n");
  if(has_range && ((qual->level != 0)
	...
	//    printf("the statistics are in dBm hahahaha!\n");
	  ...
	  else
	    {
	      ...
	      if(!(qual->updated & IW_QUAL_LEVEL_INVALID))
		{
	//	printf("Deal with signal level as relative value (0 -> max) hahahaha!\n");
	      ...
	      if(!(qual->updated & IW_QUAL_NOISE_INVALID))
		{
	//	printf("Deal with noise level as relative value (0 -> max) hahahaha!\n");
    ...
    {
  //  printf("We can't read the range, so we don't know... hahahaha!\n");
